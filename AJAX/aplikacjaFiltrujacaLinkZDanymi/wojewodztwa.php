<?php 
    ...
    $powierzchniaMIN = prawidlowaWartosc($_GET['powierzchniaMIN'] ?? null);
    $powierzchniaMAX = prawidlowaWartosc($_GET['powierzchniaMAX'] ?? null);
    $ludnoscMIN = prawidlowaWartosc($_GET['ludnoscMIN'] ?? null);
    $ludnoscMAX = prawidlowaWartosc($_GET['ludnoscMAX'] ?? null);
